<section id="section-content" class="error">
	<div class="contain-wrapper">
		<div class="container">
			<div class="text-center">
			<?php if(is_home()) : ?>
				<img class="img-responsive img-centered img-content-none" src="<?php echo get_template_directory_uri() ?>/images/comingsoon.png" alt="Coming Soon">
			<?php else : ?>
